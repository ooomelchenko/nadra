...
<div>
    <table id="lotTabR" border="3" style="font-size: 100% ; font-style: inherit">
        <tr bgcolor="sandybrown" id="lotTh">
            ...
            <th>Дата торгів</th>
            <th hidden="hidden">Газета</th>
            <th hidden="hidden">Публікація в газеті 1</th>
            <th hidden="hidden">Публікація в газеті 2</th>
            <th>Кінець реєстрації</th>
            <th>
                <button id="showBidsButt" style="font-weight: bold">+Обрати аукціон+</button>
            </th>
            <th rowspan="2" title="Повторні торги на біржі">
                <button style="width: 100px; height: 60px; font-weight: bold" class="reBidButton" value="1">Повторні торги</button>
            </th>
            <th rowspan="2" title="Повторно винесено на погодження ФГВФО">
                <button style="width: 150px; height: 60px; font-weight: bold" class="reBidButton" value="2">Необхідне перепогодження ФГВФО</button>
            </th>
        </tr>
