...
final class StaticStatus {
     static final List<String> bidStatusList = Arrays.asList("Перші торги", "Другі торги", "Треті торги", "Четверті торги", "П'яті торги", "Шості торги", "Сьомі торги", "Восьмі торги");
